...
export function Layout() {
  ...
  return (
    <div className="flex h-screen bg-slate-50">
      ...
      <aside 
        className={`fixed inset-y-0 left-0 z-50 w-72 transform bg-white border-r border-slate-200 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 ${
      ...
      >
        <div className="flex h-16 items-center justify-between px-6 border-b border-slate-100">
          ...
          <button 
            className="lg:hidden rounded-lg p-2 text-slate-500 hover:bg-slate-100 transition-colors cursor-pointer relative z-50"
            onClick={() => setIsSidebarOpen(false)}
          >
            <X className="h-5 w-5" />
          </button>
        ...
        <div className="flex flex-col justify-between h-[calc(100vh-4rem)]">
          ...
          <div className="border-t border-slate-100 p-4 relative z-10">
            ...
            <button
              ...
              className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-red-600 hover:bg-red-50 transition-colors group cursor-pointer relative z-50"
            >
      ...
      <div className="flex flex-1 flex-col overflow-hidden w-full">
        <header className="flex h-16 items-center border-b border-slate-200 bg-white/80 backdrop-blur-md px-4 lg:px-8 z-30">
          <button
            className="mr-4 lg:hidden rounded-lg p-2 text-slate-500 hover:bg-slate-100 transition-colors cursor-pointer relative z-40"
        ...
        <main className="flex-1 overflow-y-auto bg-slate-50/50 p-4 lg:p-8 w-full">
          ...
          <div className="bg-white w-full max-w-sm rounded-2xl shadow-xl overflow-hidden zoom-in-95 duration-200">
            <div className="p-6 text-center">
              ...
              <p className="text-slate-500 text-sm">
                Apakah Anda yakin ingin keluar dari sesi saat ini? Anda harus login kembali untuk mencatat transaksi.
              </p>
            </div>
